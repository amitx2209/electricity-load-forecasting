...
🔗 \*\*https://electricity-load-forecasting.streamlit.app\*\*
...
> ⚠️ \*\*Note:\*\* Screenshots are stored inside the `screenshots/` folder.
...
!\[Actual vs Predicted Electricity Load](actual\_vs\_predicted.png)
...
!\[Residual Error Plot](residual\_plot.png)
...
!\[Streamlit Application](streamlit\_app.png)
